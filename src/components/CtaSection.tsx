...
export function CtaSection({ eyebrow = "06 — Get started" }: { eyebrow?: string }) {
  return (
    ...
    >
      <div className="flex flex-col gap-2 border-b border-[#1c1c1c] pb-5 sm:flex-row-reverse sm:items-center sm:justify-between sm:gap-0 sm:pb-7">
      ...
      <div className="flex flex-1 flex-col justify-center">
        ...
        <div className="mt-12 flex flex-col items-start gap-8 sm:mt-16 sm:flex-row sm:flex-wrap sm:items-center sm:gap-12">
          <CtaButton
      ...
      <div className="flex flex-col gap-6 border-t border-[#1c1c1c] pt-8 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:gap-4 sm:pt-6">
        <span className="font-mono text-[11px] tracking-[0.12em] text-grid uppercase">
          hello@rvnwstudios.com
        </span>
        <div className="flex flex-wrap gap-x-4 gap-y-3 sm:gap-8">
          {disciplines.map((d) => (
            <span
              key={d}
